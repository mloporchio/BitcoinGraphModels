...
CLUSTERING_FILE = "atg/clustering.tsv"
OUTPUT_FILE = "atg_clustering.tsv"
...
top = df_pr.sort("clustering", descending=True).head(SIZE).select("node_id", "node_type", "entity", "label", "clustering").with_row_index("rank")
